    ...
    <UCard
      ...
      >
        ...
        <div class="flex flex-col grow">
          <div v-if="showNav.werdz">
            <div>Werdz</div>
            <WerdzNav />
          </div>
          <div v-if="showNav.werdzAdmin">
            <div>Werdz Admin</div>      
            <WerdzAdminNav />
          </div>
...
<script lang="ts" setup>
  ...
  const load = async () => {
    ...
    showNav.value.werdz = claimsHasPermission(claims, 'p:werdz-user') || claimsHasPermission(claims, 'p:werdz-admin')
    showNav.value.werdzAdmin = claimsHasPermission(claims, 'p:werdz-admin')
  }
  load()
